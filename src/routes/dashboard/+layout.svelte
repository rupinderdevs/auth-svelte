<!-- <section class="grid grid-cols-12 w-screen h-screen">
	<section class="flex items-center w-screen h-screen col-span-2">
	
		<div
			class="flex flex-col items-center w-64 h-full overflow-hidden text-gray-700 bg-gray-100 rounded"
		>
			<a class="flex items-center w-full px-3 mt-3" href="/dashboard/profile">
				<svg
			...
			<div class="w-full px-2">
				<div class="flex flex-col items-center w-full mt-3 border-t border-gray-300">
					...
					>
						...
						<a class="ml-2 text-sm font-medium" href="/dashboard/profile">Dasboard</a>
					</a>
					<a
						class="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-300"
						href="/dashboard/profile"
					>
						...
						<a class="ml-2 text-sm font-medium" href="/dashboard/table">Search</a>
					</a>
					<a
